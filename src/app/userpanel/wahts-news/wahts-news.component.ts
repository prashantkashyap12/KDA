...
@Component({
  selector: 'app-wahts-news',
  templateUrl: './wahts-news.component.html',
  styleUrls: ['./wahts-news.component.css'],
  standalone: false
})
export class WahtsNewsComponent implements OnInit {


  @ViewChild ('myFormAb',{ read: NgForm }) dataEditTemp!:NgForm;
  private apiLink = 'https://computerkendra-3711a-default-rtdb.europe-west1.firebasedatabase.app/whatsNews';
